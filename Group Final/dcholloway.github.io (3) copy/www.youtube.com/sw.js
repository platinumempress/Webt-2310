...
ytcfg.set({
    ...
    "INNERTUBE_CLIENT_VERSION": "2.20241205.05.00",
    "INNERTUBE_CONTEXT": {
        "client": {
            "hl": "en",
            "gl": "US",
    ...
    "INNERTUBE_CONTEXT_CLIENT_VERSION": "2.20241205.05.00",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
    var policy = self.trustedTypes.createPolicy('youtubeServiceWorkerPolicy', {
        createScriptURL: function(unused) {
            return 'https:\/\/www.youtube.com\/s\/desktop\/4981804c\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js';
        }
    });
    importScripts(policy.createScriptURL(''));
} else {
    importScripts('https:\/\/www.youtube.com\/s\/desktop\/4981804c\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js');
}